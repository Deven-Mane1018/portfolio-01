        ...
        <div ref={containerRef} className="hero-container">
            ...
            <div className="fixed-text-container">
                <div className="text-container fixed-text" id="text-1">
                    <h2>Hello! I am Harsh</h2>
                    <p>Business &amp; Data Analyst fresher with a passion for turning raw data into decisions that drive real business impact. Scroll to explore my work.</p>
                </div>
                <div className="text-container fixed-text" id="text-2">
                    <h2>The Analyst Mindset</h2>
                    <p>Blending statistical thinking with business intuition — from data cleaning to storytelling with data — I bridge the gap between numbers and strategy.</p>
                </div>
                <div className="text-container fixed-text" id="text-3">
                    <h2>Data Meets Impact</h2>
                    <p>Every insight should answer a business question. Let's turn data into decisions — and decisions into outcomes.</p>
                </div>
            </div>
