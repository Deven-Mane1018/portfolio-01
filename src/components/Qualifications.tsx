...
const qualifications = [
    {
        ...
        year: "2023 – 2026",
        description: "Bachelor of Computer Applications with a specialisation in AI & ML. Coursework covers data structures, statistics, database management, ML fundamentals, and Python programming.",
    ...
    },
    {
        ...
        year: "2024",
        description: "Completed end-to-end Python data analysis course covering Pandas, NumPy, Matplotlib, Seaborn, and real-world data wrangling and visualisation projects.",
        icon: <Hexagon className="w-6 h-6" />
    },
    {
        id: 3,
        title: "Tableau Desktop Specialist",
        institution: "Tableau by Salesforce",
        year: "2025",
        description: "Earned Tableau's official certification, validating skills in connecting data sources, building interactive dashboards, using calculated fields, and advanced chart types.",
